...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 13:08:43 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#JcenterRepositoryObsolete"><i class="material-icons warning-icon">warning</i>JCenter Maven repository is read-only (1)</a>
...
<tr><td></td><td class="categoryColumn"><a href="#ExtraIssues">Included Additional Checks (2)</a>
</td></tr>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:33</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno"> 30 </span>    mavenCentral()
<span class="lineno"> 31 </span>    mavenLocal()
<span class="lineno"> 32 </span>    google()
<span class="caretline"><span class="lineno"> 33 </span>    <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:39</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.1.0 is available: 1.7.1</span><br /><pre class="errorlines">
<span class="lineno"> 36 </span>
<span class="lineno"> 37 </span>dependencies {
<span class="lineno"> 38 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="caretline"><span class="lineno"> 39 </span>    implementation <span class="warning"><span class="string">'androidx.appcompat:appcompat:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 40 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 41 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 42 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:40</span>: <span class="message">A newer version of androidx.fragment:fragment than 1.2.1 is available: 1.8.9</span><br /><pre class="errorlines">
<span class="lineno"> 37 </span>dependencies {
<span class="lineno"> 38 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 39 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="caretline"><span class="lineno"> 40 </span>    implementation <span class="warning"><span class="string">'androidx.fragment:fragment:1.2.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 41 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 42 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="lineno"> 43 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:41</span>: <span class="message">A newer version of androidx.coordinatorlayout:coordinatorlayout than 1.1.0 is available: 1.3.0</span><br /><pre class="errorlines">
<span class="lineno"> 38 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 39 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 40 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="caretline"><span class="lineno"> 41 </span>    implementation <span class="warning"><span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 42 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="lineno"> 43 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
<span class="lineno"> 44 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:42</span>: <span class="message">A newer version of androidx.swiperefreshlayout:swiperefreshlayout than 1.0.0 is available: 1.1.0</span><br /><pre class="errorlines">
<span class="lineno"> 39 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 40 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 41 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="caretline"><span class="lineno"> 42 </span>    implementation <span class="warning"><span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 43 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
<span class="lineno"> 44 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:43</span>: <span class="message">A newer version of com.google.android.material:material than 1.1.0 is available: 1.13.0</span><br /><pre class="errorlines">
<span class="lineno"> 40 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 41 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 42 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="caretline"><span class="lineno"> 43 </span>    implementation <span class="warning"><span class="string">'com.google.android.material:material:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 44 </span>}
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:38</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 35 </span>}
<span class="lineno"> 36 </span>
<span class="lineno"> 37 </span>dependencies {
<span class="caretline"><span class="lineno"> 38 </span>    implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 39 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 40 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 41 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.java">../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.java</a>:169</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 166 </span>      <span class="keyword">return</span>;
<span class="lineno"> 167 </span>    }
<span class="lineno"> 168 </span>
<span class="caretline"><span class="lineno"> 169 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1</span> &amp;&amp; mDirection != <span class="keyword">null</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 170 </span>      <span class="keyword">if</span> (mDirection.equals(<span class="string">"rtl"</span>)) {
<span class="lineno"> 171 </span>        mToolbar.setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
<span class="lineno"> 172 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (mDirection.equals(<span class="string">"ltr"</span>)) {
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.java">../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.java</a>:195</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 192 </span>  }
<span class="lineno"> 193 </span>
<span class="lineno"> 194 </span>  <span class="keyword">if</span> (mIsTopInsetEnabled) {
<span class="caretline"><span class="lineno"> 195 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 196 </span>      mToolbar.setPadding(<span class="number">0</span>, getRootWindowInsets().getSystemWindowInsetTop(), <span class="number">0</span>, <span class="number">0</span>);
<span class="lineno"> 197 </span>    } <span class="keyword">else</span> {
<span class="lineno"> 198 </span>      <span class="comment">// Hacky fallback for old android. Before Marshmallow, the status bar height was always 25</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/Screen.java">../../src/main/java/com/swmansion/rnscreens/Screen.java</a>:20</span>: <span class="message">Custom view <code>Screen</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno">  17 </span><span class="keyword">import</span> com.facebook.react.bridge.ReactContext;
<span class="lineno">  18 </span><span class="keyword">import</span> com.facebook.react.uimanager.UIManagerModule;
<span class="lineno">  19 </span>
<span class="caretline"><span class="lineno">  20 </span><span class="keyword">public</span> <span class="keyword">class</span> <span class="warning">Screen</span> <span class="keyword">extends</span> ViewGroup {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  21 </span>
<span class="lineno">  22 </span>  <span class="keyword">public</span> <span class="keyword">enum</span> StackPresentation {
<span class="lineno">  23 </span>    PUSH,
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderSubview.java">../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderSubview.java</a>:10</span>: <span class="message">Custom view <code>ScreenStackHeaderSubview</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno">  7 </span><span class="keyword">import</span> com.facebook.react.uimanager.UIManagerModule;
<span class="lineno">  8 </span><span class="keyword">import</span> com.facebook.react.views.view.ReactViewGroup;
<span class="lineno">  9 </span>
<span class="caretline"><span class="lineno"> 10 </span><span class="keyword">public</span> <span class="keyword">class</span> <span class="warning">ScreenStackHeaderSubview</span> <span class="keyword">extends</span> ReactViewGroup {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 11 </span>
<span class="lineno"> 12 </span>  <span class="keyword">public</span> <span class="keyword">enum</span> Type {
<span class="lineno"> 13 </span>    LEFT,
</pre>
...
When observing a LiveData object from a fragment's onCreateView,<br/>
                | onViewCreated, onActivityCreated, or onViewStateRestored method<br/>
                | getViewLifecycleOwner() should be used as the LifecycleOwner rather than the<br/>
                | Fragment instance. The Fragment lifecycle can result in the Fragment being<br/>
                | active longer than its view. This can lead to unexpected behavior from<br/>
                | LiveData objects being observed longer than the Fragment's view is active.<br/><div class="vendor">
Vendor: Android Open Source Project (fragment-1.2.1)<br/>
Identifier: fragment-1.2.1<br/>
...
<div class="metadata"><div class="explanation">
FragmentContainerView replaces the &lt;fragment> tag as the preferred way<br/>
                | of adding fragments via XML. Unlike the &lt;fragment> tag, FragmentContainerView uses<br/>
                | a normal <code>FragmentTransaction</code> under the hood to add the initial fragment,<br/>
                | allowing further FragmentTransaction operations on the FragmentContainerView<br/>
                | and providing a consistent timing for lifecycle events.<br/><div class="moreinfo">More info: <a href="https://developer.android.com/reference/androidx/fragment/app/FragmentContainerView.html">https://developer.android.com/reference/androidx/fragment/app/FragmentContainerView.html</a>
