...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 13:08:41 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#VisibleForTests"><i class="material-icons warning-icon">warning</i>Visible Only For Tests (1)</a>
      ...
      <a class="mdl-navigation__link" href="#ObsoleteSdkInt"><i class="material-icons warning-icon">warning</i>Obsolete SDK_INT Version Check (8)</a>
      <a class="mdl-navigation__link" href="#UseSparseArrays"><i class="material-icons warning-icon">warning</i>HashMap can be replaced with SparseArray (1)</a>
    </nav>
  </div>
...
<a href="#VisibleForTests">VisibleForTests</a>: Visible Only For Tests</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
...
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#UseSparseArrays">UseSparseArrays</a>: HashMap can be replaced with SparseArray</td></tr>
...
<a name="VisibleForTests"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="VisibleForTestsCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Visible Only For Tests</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerEnabledRootView.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerEnabledRootView.java</a>:54</span>: <span class="message">This method should only be accessed from tests or within private scope</span><br /><pre class="errorlines">
<span class="lineno"> 51 </span>      <span class="keyword">throw</span> <span class="keyword">new</span> IllegalStateException(<span class="string">"GestureHandler already initialized for root view "</span> + <span class="keyword">this</span>);
<span class="lineno"> 52 </span>    }
<span class="lineno"> 53 </span>    mGestureRootHelper = <span class="keyword">new</span> RNGestureHandlerRootHelper(
<span class="caretline"><span class="lineno"> 54 </span>            mReactInstanceManager.<span class="warning">getCurrentReactContext</span>(), <span class="keyword">this</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 55 </span>  }
<span class="lineno"> 56 </span>
<span class="lineno"> 57 </span>  <span class="keyword">public</span> <span class="keyword">void</span> tearDown() {
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationVisibleForTests" style="display: none;">
This check looks for accesses from production code (e.g. not tests) where the access would not have been allowed with the intended production visibility.<br/>
<br/>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 4/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationVisibleForTestsLink" onclick="reveal('explanationVisibleForTests');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="VisibleForTestsCardLink" onclick="hideid('VisibleForTestsCard');">
Dismiss</button>            </div>
            </div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:213</span>: <span class="message">Use of this function is discouraged because resource reflection makes it harder to perform build optimizations and compile-time verification of code. It is much more efficient to retrieve resources by identifier (e.g. <code>R.foo.bar</code>) than by name (e.g. <code>getIdentifier("bar", "foo", null)</code>).</span><br /><pre class="errorlines">
<span class="lineno"> 210 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (SELECTABLE_ITEM_BACKGROUND_BORDERLESS.equals(attr)) {
<span class="lineno"> 211 </span>        <span class="keyword">return</span> android.R.attr.selectableItemBackgroundBorderless;
<span class="lineno"> 212 </span>      } <span class="keyword">else</span> {
<span class="caretline"><span class="lineno"> 213 </span>        <span class="keyword">return</span> context.getResources().<span class="warning">getIdentifier</span>(attr, <span class="string">"attr"</span>, <span class="string">"android"</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:84</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  81 </span>
<span class="lineno">  82 </span>    <span class="keyword">private</span> Drawable applyRippleEffectWhenNeeded(Drawable selectable) {
<span class="lineno">  83 </span>      <span class="keyword">if</span> (mRippleColor != <span class="keyword">null</span>
<span class="caretline"><span class="lineno">  84 </span>              &amp;&amp; <span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  85 </span>              &amp;&amp; selectable <span class="keyword">instanceof</span> RippleDrawable) {
<span class="lineno">  86 </span>        <span class="keyword">int</span>[][] states = <span class="keyword">new</span> <span class="keyword">int</span>[][]{ <span class="keyword">new</span> <span class="keyword">int</span>[]{ android.R.attr.state_enabled } };
<span class="lineno">  87 </span>        <span class="keyword">int</span>[] colors = <span class="keyword">new</span> <span class="keyword">int</span>[]{ mRippleColor };
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:91</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  88 </span>        ColorStateList colorStateList = <span class="keyword">new</span> ColorStateList(states, colors);
<span class="lineno">  89 </span>        ((RippleDrawable) selectable).setColor(colorStateList);
<span class="lineno">  90 </span>      }
<span class="caretline"><span class="lineno">  91 </span>      <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  92 </span>              &amp;&amp; mRippleRadius != <span class="keyword">null</span>
<span class="lineno">  93 </span>              &amp;&amp; selectable <span class="keyword">instanceof</span> RippleDrawable) {
<span class="lineno">  94 </span>        RippleDrawable rippleDrawable = (RippleDrawable) selectable;
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:146</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 143 </span>        <span class="comment">// reset background</span>
<span class="lineno"> 144 </span>        setBackground(<span class="keyword">null</span>);
...
<span class="lineno"> 147 </span>        <span class="comment">// reset foreground</span>
<span class="lineno"> 148 </span>        setForeground(<span class="keyword">null</span>);
<span class="lineno"> 149 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:150</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 147 </span>        <span class="comment">// reset foreground</span>
<span class="lineno"> 148 </span>        setForeground(<span class="keyword">null</span>);
<span class="lineno"> 149 </span>      }
<span class="caretline"><span class="lineno"> 150 </span>      <span class="keyword">if</span> (mUseForeground &amp;&amp; <span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 151 </span>        setForeground(applyRippleEffectWhenNeeded(createSelectableDrawable()));
<span class="lineno"> 152 </span>        <span class="keyword">if</span> (mBackgroundColor != Color.TRANSPARENT) {
<span class="lineno"> 153 </span>          setBackgroundColor(mBackgroundColor);
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:169</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 166 </span>  <span class="comment">// 1. ReactViewManager is not a generic class with a possibility to handle another ViewGroup</span>
<span class="lineno"> 167 </span>  <span class="comment">// 2. There's no way to force native behavior of ReactViewGroup's superclass's onTouchEvent</span>
<span class="lineno"> 168 </span>  colorDrawable.setCornerRadius(mBorderRadius);
<span class="caretline"><span class="lineno"> 169 </span>  <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 170 </span>        &amp;&amp; selectable <span class="keyword">instanceof</span> RippleDrawable) {
<span class="lineno"> 171 </span>    PaintDrawable mask = <span class="keyword">new</span> PaintDrawable(Color.WHITE);
<span class="lineno"> 172 </span>    mask.setCornerRadius(mBorderRadius);
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:205</span>: <span class="message">Unnecessary; SDK_INT is always >= 21</span><br /><pre class="errorlines">
<span class="lineno"> 202 </span>      }
<span class="lineno"> 203 </span>    }
<span class="lineno"> 204 </span>
<span class="caretline"><span class="lineno"> 205 </span>    <span class="warning"><span class="annotation">@TargetApi</span>(Build.VERSION_CODES.LOLLIPOP)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 206 </span>    <span class="keyword">private</span> <span class="keyword">static</span> <span class="keyword">int</span> getAttrId(Context context, String attr) {
<span class="lineno"> 207 </span>      SoftAssertions.assertNotNull(attr);
<span class="lineno"> 208 </span>      <span class="keyword">if</span> (SELECTABLE_ITEM_BACKGROUND.equals(attr)) {
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerButtonViewManager.java</a>:261</span>: <span class="message">Unnecessary; SDK_INT is always >= 23</span><br /><pre class="errorlines">
<span class="lineno"> 258 </span>    <span class="keyword">return</span> <span class="keyword">new</span> ButtonViewGroup(context);
<span class="lineno"> 259 </span>  }
<span class="lineno"> 260 </span>
<span class="caretline"><span class="lineno"> 261 </span>  <span class="warning"><span class="annotation">@TargetApi</span>(Build.VERSION_CODES.M)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 262 </span>  <span class="annotation">@ReactProp</span>(name = <span class="string">"foreground"</span>)
<span class="lineno"> 263 </span>  <span class="keyword">public</span> <span class="keyword">void</span> setForeground(ButtonViewGroup view, <span class="keyword">boolean</span> useDrawableOnForeground) {
<span class="lineno"> 264 </span>    view.setUseDrawableOnForeground(useDrawableOnForeground);
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNViewConfigurationHelper.java">../../src/main/java/com/swmansion/gesturehandler/react/RNViewConfigurationHelper.java</a>:52</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 49 </span>
<span class="lineno"> 50 </span>  <span class="annotation">@Override</span>
<span class="lineno"> 51 </span>  <span class="keyword">public</span> <span class="keyword">boolean</span> isViewClippingChildren(ViewGroup view) {
<span class="caretline"><span class="lineno"> 52 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2</span> &amp;&amp; !view.getClipChildren()) {&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 53 </span>        <span class="keyword">if</span> (view <span class="keyword">instanceof</span> ReactViewGroup) {
<span class="lineno"> 54 </span>            String overflow = ((ReactViewGroup) view).getOverflow();
<span class="lineno"> 55 </span>            <span class="keyword">return</span> <span class="string">"hidden"</span>.equals(overflow);
</pre>
...
Dismiss</button>            </div>
          ...
          </section><a name="UseSparseArrays"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="UseSparseArraysCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">HashMap can be replaced with SparseArray</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerRegistry.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerRegistry.java</a>:17</span>: <span class="message">Use <code>new SparseIntArray(...)</code> instead for better performance</span><br /><pre class="errorlines">
<span class="lineno">  14 </span><span class="keyword">public</span> <span class="keyword">class</span> RNGestureHandlerRegistry <span class="keyword">implements</span> GestureHandlerRegistry {
<span class="lineno">  15 </span>
<span class="lineno">  16 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;GestureHandler> mHandlers = <span class="keyword">new</span> SparseArray&lt;>();
<span class="caretline"><span class="lineno">  17 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;Integer> mAttachedTo = <span class="warning"><span class="keyword">new</span> SparseArray&lt;>()</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  18 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;ArrayList&lt;GestureHandler>> mHandlersForView = <span class="keyword">new</span> SparseArray&lt;>();
<span class="lineno">  19 </span>
<span class="lineno">  20 </span>  <span class="keyword">public</span> <span class="keyword">synchronized</span> <span class="keyword">void</span> registerHandler(GestureHandler handler) {
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationUseSparseArrays" style="display: none;">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 4/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationUseSparseArraysLink" onclick="reveal('explanationUseSparseArrays');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="UseSparseArraysCardLink" onclick="hideid('UseSparseArraysCard');">
Dismiss</button>            </div>
            </div>
          </section>
