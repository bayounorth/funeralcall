...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 4 errors and 9 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 13:45:48 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#JcenterRepositoryObsolete"><i class="material-icons warning-icon">warning</i>JCenter Maven repository is read-only (2)</a>
      <a class="mdl-navigation__link" href="#WrongConstant"><i class="material-icons error-icon">error</i>Incorrect constant (4)</a>
      ...
      <a class="mdl-navigation__link" href="#ObsoleteSdkInt"><i class="material-icons warning-icon">warning</i>Obsolete SDK_INT Version Check (6)</a>
    </nav>
  </div>
...
<a href="#JcenterRepositoryObsolete">JcenterRepositoryObsolete</a>: JCenter Maven repository is read-only</td></tr>
<tr>
...
<a name="JcenterRepositoryObsolete"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="JcenterRepositoryObsoleteCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">JCenter Maven repository is read-only</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:12</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno">  9 </span>    <span class="keyword">if</span> (project == rootProject) {
<span class="lineno"> 10 </span>        repositories {
<span class="lineno"> 11 </span>            google()
<span class="caretline"><span class="lineno"> 12 </span>            <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 13 </span>        }
<span class="lineno"> 14 </span>        
<span class="lineno"> 15 </span>        dependencies {
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:43</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno"> 40 </span>repositories {
<span class="lineno"> 41 </span>    mavenLocal()
<span class="lineno"> 42 </span>    google()
<span class="caretline"><span class="lineno"> 43 </span>    <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 44 </span>    maven {
<span class="lineno"> 45 </span>        <span class="comment">// All of React Native (JS, Obj-C sources, Android binaries) is installed from npm</span>
<span class="lineno"> 46 </span>        url <span class="string">"$rootDir/../node_modules/react-native/android"</span>
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationJcenterRepositoryObsolete" style="display: none;">
...
To suppress this error, use the issue id "JcenterRepositoryObsolete" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">JcenterRepositoryObsolete</span>
</span>
<span class="mdl-chip">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 8/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationJcenterRepositoryObsoleteLink" onclick="reveal('explanationJcenterRepositoryObsolete');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="JcenterRepositoryObsoleteCardLink" onclick="hideid('JcenterRepositoryObsoleteCard');">
Dismiss</button>            </div>
            </div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/horcrux/svg/RenderableView.java">../../src/main/java/com/horcrux/svg/RenderableView.java</a>:427</span>: <span class="message">Must be one or more of: Paint.ANTI_ALIAS_FLAG, Paint.FILTER_BITMAP_FLAG, Paint.DITHER_FLAG, Paint.UNDERLINE_TEXT_FLAG, Paint.STRIKE_THRU_TEXT_FLAG, Paint.FAKE_BOLD_TEXT_FLAG, Paint.LINEAR_TEXT_FLAG, Paint.SUBPIXEL_TEXT_FLAG, Paint.EMBEDDED_BITMAP_TEXT_FLAG, Paint.TEXT_RUN_FLAG_LEFT_EDGE, Paint.TEXT_RUN_FLAG_RIGHT_EDGE</span><br /><pre class="errorlines">
<span class="lineno"> 424 </span>  <span class="keyword">private</span> <span class="keyword">boolean</span> setupFillPaint(Paint paint, <span class="keyword">float</span> opacity) {
<span class="lineno"> 425 </span>      <span class="keyword">if</span> (fill != <span class="keyword">null</span> &amp;&amp; fill.size() > <span class="number">0</span>) {
<span class="lineno"> 426 </span>          paint.reset();
<span class="caretline"><span class="lineno"> 427 </span>          paint.setFlags(Paint.ANTI_ALIAS_FLAG | <span class="error">Paint.DEV_KERN_TEXT_FLAG</span> | Paint.SUBPIXEL_TEXT_FLAG);</span>
<span class="lineno"> 428 </span>          paint.setStyle(Paint.Style.FILL);
<span class="lineno"> 429 </span>          setupPaint(paint, opacity, fill);
<span class="lineno"> 430 </span>          <span class="keyword">return</span> <span class="keyword">true</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/RenderableView.java">../../src/main/java/com/horcrux/svg/RenderableView.java</a>:446</span>: <span class="message">Must be one or more of: Paint.ANTI_ALIAS_FLAG, Paint.FILTER_BITMAP_FLAG, Paint.DITHER_FLAG, Paint.UNDERLINE_TEXT_FLAG, Paint.STRIKE_THRU_TEXT_FLAG, Paint.FAKE_BOLD_TEXT_FLAG, Paint.LINEAR_TEXT_FLAG, Paint.SUBPIXEL_TEXT_FLAG, Paint.EMBEDDED_BITMAP_TEXT_FLAG, Paint.TEXT_RUN_FLAG_LEFT_EDGE, Paint.TEXT_RUN_FLAG_RIGHT_EDGE</span><br /><pre class="errorlines">
<span class="lineno"> 443 </span>      <span class="keyword">return</span> <span class="keyword">false</span>;
<span class="lineno"> 444 </span>  }
<span class="lineno"> 445 </span>
<span class="caretline"><span class="lineno"> 446 </span>  paint.setFlags(Paint.ANTI_ALIAS_FLAG | <span class="error">Paint.DEV_KERN_TEXT_FLAG</span> | Paint.SUBPIXEL_TEXT_FLAG);</span>
<span class="lineno"> 447 </span>  paint.setStyle(Paint.Style.STROKE);
<span class="lineno"> 448 </span>  paint.setStrokeCap(strokeLinecap);
<span class="lineno"> 449 </span>  paint.setStrokeJoin(strokeLinejoin);
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/SvgView.java">../../src/main/java/com/horcrux/svg/SvgView.java</a>:285</span>: <span class="message">Must be one or more of: Paint.ANTI_ALIAS_FLAG, Paint.FILTER_BITMAP_FLAG, Paint.DITHER_FLAG, Paint.UNDERLINE_TEXT_FLAG, Paint.STRIKE_THRU_TEXT_FLAG, Paint.FAKE_BOLD_TEXT_FLAG, Paint.LINEAR_TEXT_FLAG, Paint.SUBPIXEL_TEXT_FLAG, Paint.EMBEDDED_BITMAP_TEXT_FLAG, Paint.TEXT_RUN_FLAG_LEFT_EDGE, Paint.TEXT_RUN_FLAG_RIGHT_EDGE</span><br /><pre class="errorlines">
<span class="lineno"> 282 </span>
<span class="lineno"> 283 </span>  <span class="keyword">final</span> Paint paint = <span class="keyword">new</span> Paint();
<span class="lineno"> 284 </span>
<span class="caretline"><span class="lineno"> 285 </span>  paint.setFlags(Paint.ANTI_ALIAS_FLAG | <span class="error">Paint.DEV_KERN_TEXT_FLAG</span> | Paint.SUBPIXEL_TEXT_FLAG);</span>
<span class="lineno"> 286 </span>
<span class="lineno"> 287 </span>  paint.setTypeface(Typeface.DEFAULT);
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/TSpanView.java">../../src/main/java/com/horcrux/svg/TSpanView.java</a>:178</span>: <span class="message">Must be one of: LineBreaker.BREAK_STRATEGY_SIMPLE, LineBreaker.BREAK_STRATEGY_HIGH_QUALITY, LineBreaker.BREAK_STRATEGY_BALANCED</span><br /><pre class="errorlines">
<span class="lineno">  175 </span>                    .setAlignment(align)
<span class="lineno">  176 </span>                    .setLineSpacing(<span class="number">0.f</span>, <span class="number">1.f</span>)
<span class="lineno">  177 </span>                    .setIncludePad(includeFontPadding)
<span class="caretline"><span class="lineno">  178 </span>                    .setBreakStrategy(<span class="error">Layout.BREAK_STRATEGY_HIGH_QUALITY</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  179 </span>                    .setHyphenationFrequency(Layout.HYPHENATION_FREQUENCY_NORMAL)
<span class="lineno">  180 </span>                    .build();
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:17</span>: <span class="message">A newer version of com.android.tools.build:gradle than 3.5.1 is available: 8.13.1. (There is also a newer version of 3.5.&#55349;&#56421; available, if upgrading to 8.13.1 is difficult: 3.5.4)</span><br /><pre class="errorlines">
<span class="lineno"> 14 </span>        
<span class="lineno"> 15 </span>        dependencies {
<span class="lineno"> 16 </span>            <span class="comment">//noinspection GradleDependency</span>
<span class="caretline"><span class="lineno"> 17 </span>            classpath(<span class="warning"><span class="string">"com.android.tools.build:gradle:3.5.1"</span></span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/horcrux/svg/GroupView.java">../../src/main/java/com/horcrux/svg/GroupView.java</a>:158</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 155 </span>    Path getPath(<span class="keyword">final</span> Canvas canvas, <span class="keyword">final</span> Paint paint, <span class="keyword">final</span> Region.Op op) {
<span class="lineno"> 156 </span>        <span class="keyword">final</span> Path path = <span class="keyword">new</span> Path();
<span class="lineno"> 157 </span>
<span class="caretline"><span class="lineno"> 158 </span>        <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 159 </span>            <span class="keyword">final</span> Path.Op pop = Path.Op.valueOf(op.name());
<span class="lineno"> 160 </span>            <span class="keyword">for</span> (<span class="keyword">int</span> i = <span class="number">0</span>; i &lt; getChildCount(); i++) {
<span class="lineno"> 161 </span>                View node = getChildAt(i);
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/RectView.java">../../src/main/java/com/horcrux/svg/RectView.java</a>:101</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  98 </span>  <span class="keyword">if</span> (ry > h / <span class="number">2</span>) {
<span class="lineno">  99 </span>      ry = h / <span class="number">2</span>;
<span class="lineno"> 100 </span>  }
<span class="caretline"><span class="lineno"> 101 </span>  <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 102 </span>      path.addRoundRect((<span class="keyword">float</span>) x, (<span class="keyword">float</span>) y, (<span class="keyword">float</span>) (x + w), (<span class="keyword">float</span>) (y + h), (<span class="keyword">float</span>) rx, (<span class="keyword">float</span>) ry, Path.Direction.CW);
<span class="lineno"> 103 </span>  } <span class="keyword">else</span> {
<span class="lineno"> 104 </span>      path.addRoundRect(<span class="keyword">new</span> RectF((<span class="keyword">float</span>) x, (<span class="keyword">float</span>) y, (<span class="keyword">float</span>) (x + w), (<span class="keyword">float</span>) (y + h)), (<span class="keyword">float</span>) rx, (<span class="keyword">float</span>) ry, Path.Direction.CW);
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/TSpanView.java">../../src/main/java/com/horcrux/svg/TSpanView.java</a>:164</span>: <span class="message">Unnecessary; SDK_INT is never &lt; 24</span><br /><pre class="errorlines">
<span class="lineno">  161 </span>
<span class="lineno">  162 </span>  <span class="annotation">@SuppressWarnings</span>(<span class="string">"deprecation"</span>)
<span class="lineno">  163 </span>  <span class="keyword">private</span> StaticLayout getStaticLayout(TextPaint tp, Layout.Alignment align, <span class="keyword">boolean</span> includeFontPadding, SpannableString text, <span class="keyword">int</span> width) {
<span class="caretline"><span class="lineno">  164 </span>      <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT &lt; Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  165 </span>          <span class="keyword">return</span> <span class="keyword">new</span> StaticLayout(
<span class="lineno">  166 </span>                  text,
<span class="lineno">  167 </span>                  tp,
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/TSpanView.java">../../src/main/java/com/horcrux/svg/TSpanView.java</a>:307</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  304 </span>    <span class="keyword">final</span> <span class="keyword">static</span> String fontWeightTag = <span class="string">"'wght' "</span>;
<span class="lineno">  305 </span>
<span class="lineno">  306 </span>    <span class="keyword">private</span> <span class="keyword">void</span> applySpacingAndFeatures(Paint paint, FontData font) {
<span class="caretline"><span class="lineno">  307 </span>        <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  308 </span>            <span class="keyword">double</span> letterSpacing = font.letterSpacing;
<span class="lineno">  309 </span>            paint.setLetterSpacing((<span class="keyword">float</span>) (letterSpacing / (font.fontSize * mScale)));
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/TSpanView.java">../../src/main/java/com/horcrux/svg/TSpanView.java</a>:489</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  486 </span><span class="comment">      TODO For upright text within vertical text runs,
</span><span class="lineno">  487 </span><span class="comment">      vertical alternates (OpenType feature: vert) must be enabled.
</span><span class="lineno">  488 </span><span class="comment">  */</span>
<span class="caretline"><span class="lineno">  489 </span>  <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  490 </span>      <span class="comment">// String arabic = "'isol', 'fina', 'medi', 'init', 'rclt', 'mset', 'curs', ";</span>
<span class="lineno">  491 </span>      <span class="keyword">if</span> (allowOptionalLigatures) {
<span class="lineno">  492 </span>          paint.setFontFeatureSettings(defaultFeatures + additionalLigatures + font.fontFeatureSettings);
</pre>

<span class="location"><a href="../../src/main/java/com/horcrux/svg/TSpanView.java">../../src/main/java/com/horcrux/svg/TSpanView.java</a>:1193</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 1190 </span>        paint.setSubpixelText(<span class="keyword">true</span>);
<span class="lineno"> 1191 </span>        paint.setTypeface(typeface);
<span class="lineno"> 1192 </span>        paint.setTextSize((<span class="keyword">float</span>) (font.fontSize * mScale));
<span class="caretline"><span class="lineno"> 1193 </span>        <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 1194 </span>            paint.setLetterSpacing(<span class="number">0</span>);
