...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 19 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 13:33:25 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ObsoleteSdkInt"><i class="material-icons warning-icon">warning</i>Obsolete SDK_INT Version Check (18)</a>
    </nav>
  </div>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:55</span>: <span class="message">A newer version of com.android.installreferrer:installreferrer than 1.1.2 is available: 2.2</span><br /><pre class="errorlines">
<span class="lineno"> 52 </span>
<span class="lineno"> 53 </span>dependencies {
<span class="lineno"> 54 </span>  implementation <span class="string">"com.facebook.react:react-native:${</span>safeExtGet(<span class="string">'reactNativeVersion'</span>, <span class="string">'+'</span>)<span class="string">}"</span>
<span class="caretline"><span class="lineno"> 55 </span>  implementation <span class="warning"><span class="string">"com.android.installreferrer:installreferrer:${</span>safeExtGet(<span class="string">'installReferrerVersion'</span>, <span class="string">'1.1.2'</span>)<span class="string">}"</span></span></span>
<span class="lineno"> 56 </span>  <span class="keyword">def</span> firebaseBomVersion = safeExtGet(<span class="string">"firebaseBomVersion"</span>, <span class="keyword">null</span>)
<span class="lineno"> 57 </span>  <span class="keyword">def</span> firebaseIidVersion = safeExtGet(<span class="string">'firebaseIidVersion'</span>, <span class="keyword">null</span>)
<span class="lineno"> 58 </span>  <span class="keyword">if</span> (firebaseBomVersion) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/resolver/DeviceTypeResolver.java">../../src/main/java/com/learnium/RNDeviceInfo/resolver/DeviceTypeResolver.java</a>:72</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 69 </span>    <span class="comment">// Get display metrics to see if we can differentiate handsets and tablets.</span>
<span class="lineno"> 70 </span>    <span class="comment">// NOTE: for API level 16 the metrics will exclude window decor.</span>
<span class="lineno"> 71 </span>    DisplayMetrics metrics = <span class="keyword">new</span> DisplayMetrics();
<span class="caretline"><span class="lineno"> 72 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 73 </span>      windowManager.getDefaultDisplay().getRealMetrics(metrics);
<span class="lineno"> 74 </span>    } <span class="keyword">else</span> {
<span class="lineno"> 75 </span>      windowManager.getDefaultDisplay().getMetrics(metrics);
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:96</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno">  93 </span>    filter.addAction(Intent.ACTION_BATTERY_CHANGED);
<span class="lineno">  94 </span>    filter.addAction(Intent.ACTION_POWER_CONNECTED);
<span class="lineno">  95 </span>    filter.addAction(Intent.ACTION_POWER_DISCONNECTED);
<span class="caretline"><span class="lineno">  96 </span>    <span class="keyword">if</span> (<span class="warning">android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  97 </span>      filter.addAction(PowerManager.ACTION_POWER_SAVE_MODE_CHANGED);
<span class="lineno">  98 </span>    }
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:279</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 276 </span>  <span class="annotation">@SuppressWarnings</span>(<span class="string">"deprecation"</span>)
<span class="lineno"> 277 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 278 </span>  <span class="keyword">public</span> <span class="keyword">boolean</span> isCameraPresentSync() {
<span class="caretline"><span class="lineno"> 279 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 280 </span>      CameraManager manager=(CameraManager)getReactApplicationContext().getSystemService(Context.CAMERA_SERVICE);
<span class="lineno"> 281 </span>      <span class="keyword">try</span> {
<span class="lineno"> 282 </span>        <span class="keyword">return</span> manager.getCameraIdList().length > <span class="number">0</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:370</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 367 </span>  <span class="keyword">public</span> <span class="keyword">void</span> getTotalDiskCapacity(Promise p) { p.resolve(getTotalDiskCapacitySync()); }
<span class="lineno"> 368 </span>
<span class="lineno"> 369 </span>  <span class="keyword">private</span> BigInteger getDirTotalCapacity(StatFs dir) {
<span class="caretline"><span class="lineno"> 370 </span>    <span class="keyword">boolean</span> intApiDeprecated = <span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 371 </span>    <span class="keyword">long</span> blockCount = intApiDeprecated ? dir.getBlockCountLong() : dir.getBlockCount();
<span class="lineno"> 372 </span>    <span class="keyword">long</span> blockSize = intApiDeprecated ? dir.getBlockSizeLong() : dir.getBlockSize();
<span class="lineno"> 373 </span>    <span class="keyword">return</span> BigInteger.valueOf(blockCount).multiply(BigInteger.valueOf(blockSize));
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:382</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 379 </span>  StatFs rootDir = <span class="keyword">new</span> StatFs(Environment.getRootDirectory().getAbsolutePath());
<span class="lineno"> 380 </span>  StatFs dataDir = <span class="keyword">new</span> StatFs(Environment.getDataDirectory().getAbsolutePath());
<span class="lineno"> 381 </span>
<span class="caretline"><span class="lineno"> 382 </span>  Boolean intApiDeprecated = <span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 383 </span>  <span class="keyword">long</span> rootAvailableBlocks = getTotalAvailableBlocks(rootDir, intApiDeprecated);
<span class="lineno"> 384 </span>  <span class="keyword">long</span> rootBlockSize = getBlockSize(rootDir, intApiDeprecated);
<span class="lineno"> 385 </span>  <span class="keyword">double</span> rootFree = BigInteger.valueOf(rootAvailableBlocks).multiply(BigInteger.valueOf(rootBlockSize)).doubleValue();
</pre>

<button class="mdl-button mdl-js-button mdl-button--primary" id="ObsoleteSdkIntDivLink" onclick="reveal('ObsoleteSdkIntDiv');" />+ 13 More Occurrences...</button>
<div id="ObsoleteSdkIntDiv" style="display: none">
<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:427</span>: <span class="message">Unnecessary; SDK_INT is never &lt; 24</span><br /><pre class="errorlines">
<span class="lineno"> 424 </span>      <span class="keyword">long</span> availableBlocks;
<span class="lineno"> 425 </span>      <span class="keyword">long</span> blockSize;
<span class="lineno"> 426 </span>
<span class="caretline"><span class="lineno"> 427 </span>      <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT &lt; Build.VERSION_CODES.JELLY_BEAN_MR2</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 428 </span>        availableBlocks = external.getAvailableBlocks();
<span class="lineno"> 429 </span>        blockSize = external.getBlockSize();
<span class="lineno"> 430 </span>      } <span class="keyword">else</span> {
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:492</span>: <span class="message">Unnecessary; SDK_INT is never &lt; 24</span><br /><pre class="errorlines">
<span class="lineno"> 489 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 490 </span>  <span class="keyword">public</span> <span class="keyword">boolean</span> isAirplaneModeSync() {
<span class="lineno"> 491 </span>    <span class="keyword">boolean</span> isAirplaneMode;
<span class="caretline"><span class="lineno"> 492 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT &lt; Build.VERSION_CODES.JELLY_BEAN_MR1</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 493 </span>      isAirplaneMode = Settings.System.getInt(getReactApplicationContext().getContentResolver(),Settings.System.AIRPLANE_MODE_ON, <span class="number">0</span>) != <span class="number">0</span>;
<span class="lineno"> 494 </span>    } <span class="keyword">else</span> {
<span class="lineno"> 495 </span>      isAirplaneMode = Settings.Global.getInt(getReactApplicationContext().getContentResolver(),Settings.Global.AIRPLANE_MODE_ON, <span class="number">0</span>) != <span class="number">0</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:573</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 570 </span>      System.err.println(<span class="string">"Unable to determine if location enabled. LocationManager was null"</span>);
<span class="lineno"> 571 </span>      <span class="keyword">return</span> <span class="keyword">false</span>;
<span class="lineno"> 572 </span>    }
<span class="caretline"><span class="lineno"> 573 </span>  } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 574 </span>    <span class="keyword">int</span> locationMode = Settings.Secure.getInt(getReactApplicationContext().getContentResolver(), Settings.Secure.LOCATION_MODE, Settings.Secure.LOCATION_MODE_OFF);
<span class="lineno"> 575 </span>    locationEnabled = locationMode != Settings.Secure.LOCATION_MODE_OFF;
<span class="lineno"> 576 </span>  } <span class="keyword">else</span> {
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:814</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 811 </span>
<span class="lineno"> 812 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 813 </span>  <span class="keyword">public</span> String getBaseOsSync() {
<span class="caretline"><span class="lineno"> 814 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 815 </span>      <span class="keyword">return</span> Build.VERSION.BASE_OS;
<span class="lineno"> 816 </span>    }
<span class="lineno"> 817 </span>    <span class="keyword">return</span> <span class="string">"unknown"</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:824</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 821 </span>
<span class="lineno"> 822 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 823 </span>  <span class="keyword">public</span> String getPreviewSdkIntSync() {
<span class="caretline"><span class="lineno"> 824 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 825 </span>      <span class="keyword">return</span> Integer.toString(Build.VERSION.PREVIEW_SDK_INT);
<span class="lineno"> 826 </span>    }
<span class="lineno"> 827 </span>    <span class="keyword">return</span> <span class="string">"unknown"</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:834</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 831 </span>
<span class="lineno"> 832 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 833 </span>  <span class="keyword">public</span> String getSecurityPatchSync() {
<span class="caretline"><span class="lineno"> 834 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 835 </span>      <span class="keyword">return</span> Build.VERSION.SECURITY_PATCH;
<span class="lineno"> 836 </span>    }
<span class="lineno"> 837 </span>    <span class="keyword">return</span> <span class="string">"unknown"</span>;
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:845</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 842 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 843 </span>  <span class="keyword">public</span> String getUserAgentSync() {
<span class="lineno"> 844 </span>    <span class="keyword">try</span> {
<span class="caretline"><span class="lineno"> 845 </span>      <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 846 </span>        <span class="keyword">return</span> WebSettings.getDefaultUserAgent(getReactApplicationContext());
<span class="lineno"> 847 </span>      } <span class="keyword">else</span> {
<span class="lineno"> 848 </span>        <span class="keyword">return</span> System.getProperty(<span class="string">"http.agent"</span>);
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:862</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 859 </span>  <span class="keyword">public</span> String getPhoneNumberSync() {
<span class="lineno"> 860 </span>    <span class="keyword">if</span> (getReactApplicationContext() != <span class="keyword">null</span> &amp;&amp;
<span class="lineno"> 861 </span>            (getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED ||
<span class="caretline"><span class="lineno"> 862 </span>                    (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span> &amp;&amp; getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED) ||</span>
<span class="lineno"> 863 </span>                    (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O &amp;&amp; getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_PHONE_NUMBERS) == PackageManager.PERMISSION_GRANTED))) {
<span class="lineno"> 864 </span>      TelephonyManager telMgr = (TelephonyManager) getReactApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
<span class="lineno"> 865 </span>      <span class="keyword">if</span> (telMgr != <span class="keyword">null</span>) {
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:863</span>: <span class="message">Unnecessary;` Build.VERSION.SDK_INT >= Build.VERSION_CODES.O` is never true here</span><br /><pre class="errorlines">
<span class="lineno"> 860 </span>  <span class="keyword">if</span> (getReactApplicationContext() != <span class="keyword">null</span> &amp;&amp;
<span class="lineno"> 861 </span>          (getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED ||
<span class="lineno"> 862 </span>                  (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &amp;&amp; getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED) ||
<span class="caretline"><span class="lineno"> 863 </span>                  (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.O</span> &amp;&amp; getReactApplicationContext().checkCallingOrSelfPermission(Manifest.permission.READ_PHONE_NUMBERS) == PackageManager.PERMISSION_GRANTED))) {</span>
<span class="lineno"> 864 </span>    TelephonyManager telMgr = (TelephonyManager) getReactApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
<span class="lineno"> 865 </span>    <span class="keyword">if</span> (telMgr != <span class="keyword">null</span>) {
<span class="lineno"> 866 </span>      <span class="keyword">return</span> telMgr.getLine1Number();
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:879</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 876 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 877 </span>  <span class="keyword">public</span> WritableArray getSupportedAbisSync() {
<span class="lineno"> 878 </span>    WritableArray array = <span class="keyword">new</span> WritableNativeArray();
<span class="caretline"><span class="lineno"> 879 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 880 </span>      <span class="keyword">for</span> (String abi : Build.SUPPORTED_ABIS) {
<span class="lineno"> 881 </span>        array.pushString(abi);
<span class="lineno"> 882 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:894</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 891 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 892 </span>  <span class="keyword">public</span> WritableArray getSupported32BitAbisSync() {
<span class="lineno"> 893 </span>    WritableArray array = <span class="keyword">new</span> WritableNativeArray();
<span class="caretline"><span class="lineno"> 894 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 895 </span>      <span class="keyword">for</span> (String abi : Build.SUPPORTED_32_BIT_ABIS) {
<span class="lineno"> 896 </span>        array.pushString(abi);
<span class="lineno"> 897 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:907</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 904 </span>  <span class="annotation">@ReactMethod</span>(isBlockingSynchronousMethod = <span class="keyword">true</span>)
<span class="lineno"> 905 </span>  <span class="keyword">public</span> WritableArray getSupported64BitAbisSync() {
<span class="lineno"> 906 </span>    WritableArray array = <span class="keyword">new</span> WritableNativeArray();
<span class="caretline"><span class="lineno"> 907 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 908 </span>      <span class="keyword">for</span> (String abi : Build.SUPPORTED_64_BIT_ABIS) {
<span class="lineno"> 909 </span>        array.pushString(abi);
<span class="lineno"> 910 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java">../../src/main/java/com/learnium/RNDeviceInfo/RNDeviceModule.java</a>:942</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 939 </span>
<span class="lineno"> 940 </span>  PowerManager powerManager = (PowerManager)getReactApplicationContext().getSystemService(Context.POWER_SERVICE);
<span class="lineno"> 941 </span>  <span class="keyword">boolean</span> powerSaveMode = <span class="keyword">false</span>;
<span class="caretline"><span class="lineno"> 942 </span>  <span class="keyword">if</span> (<span class="warning">android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 943 </span>    powerSaveMode = powerManager.isPowerSaveMode();
