...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 12:54:13 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#StaticFieldLeak"><i class="material-icons warning-icon">warning</i>Static Field Leaks (7)</a>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:42</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno">  39 </span>
<span class="lineno">  40 </span>    repositories {
<span class="lineno">  41 </span>        google()
<span class="caretline"><span class="lineno">  42 </span>        <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  43 </span>    }
<span class="lineno">  44 </span>    dependencies {
<span class="lineno">  45 </span>        <span class="keyword">if</span> (project == rootProject) {
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:107</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno"> 104 </span>        url <span class="string">"${</span>resolveModulePath(<span class="string">"react-native"</span>)<span class="string">}/android"</span>
<span class="lineno"> 105 </span>    }
<span class="lineno"> 106 </span>    google()
<span class="caretline"><span class="lineno"> 107 </span>    <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 108 </span>}
<span class="lineno"> 109 </span>
<span class="lineno"> 110 </span>dependencies {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:46</span>: <span class="message">A newer version of com.android.tools.build:gradle than 3.6.4 is available: 8.13.1</span><br /><pre class="errorlines">
<span class="lineno">  43 </span>    }
<span class="lineno">  44 </span>    dependencies {
<span class="lineno">  45 </span>        <span class="keyword">if</span> (project == rootProject) {
<span class="caretline"><span class="lineno">  46 </span>            classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:3.6.4'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  47 </span>            classpath <span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:$asyncStorageKtVersion"</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:119</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 116 </span>      <span class="keyword">return</span>;
<span class="lineno"> 117 </span>    }
<span class="lineno"> 118 </span>
<span class="caretline"><span class="lineno"> 119 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 120 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 121 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 122 </span>        <span class="keyword">if</span> (!ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:192</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 189 </span>      <span class="keyword">return</span>;
<span class="lineno"> 190 </span>    }
<span class="lineno"> 191 </span>
<span class="caretline"><span class="lineno"> 192 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 193 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 194 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 195 </span>        <span class="keyword">if</span> (!ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:257</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 254 </span>      <span class="keyword">return</span>;
<span class="lineno"> 255 </span>    }
<span class="lineno"> 256 </span>
<span class="caretline"><span class="lineno"> 257 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 258 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 259 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 260 </span>        <span class="keyword">if</span> (!ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:304</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 301 </span><span class="javadoc">   */</span>
<span class="lineno"> 302 </span>  <span class="annotation">@ReactMethod</span>
<span class="lineno"> 303 </span>  <span class="keyword">public</span> <span class="keyword">void</span> multiMerge(<span class="keyword">final</span> ReadableArray keyValueArray, <span class="keyword">final</span> Callback callback) {
<span class="caretline"><span class="lineno"> 304 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 305 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 306 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 307 </span>        <span class="keyword">if</span> (!ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:366</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 363 </span><span class="javadoc">   */</span>
<span class="lineno"> 364 </span>  <span class="annotation">@ReactMethod</span>
<span class="lineno"> 365 </span>  <span class="keyword">public</span> <span class="keyword">void</span> clear(<span class="keyword">final</span> Callback callback) {
<span class="caretline"><span class="lineno"> 366 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 367 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 368 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 369 </span>        <span class="keyword">if</span> (!mReactDatabaseSupplier.ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageModule.java</a>:389</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.facebook.react.bridge.GuardedAsyncTask)</span><br /><pre class="errorlines">
<span class="lineno"> 386 </span><span class="javadoc">   */</span>
<span class="lineno"> 387 </span>  <span class="annotation">@ReactMethod</span>
<span class="lineno"> 388 </span>  <span class="keyword">public</span> <span class="keyword">void</span> getAllKeys(<span class="keyword">final</span> Callback callback) {
<span class="caretline"><span class="lineno"> 389 </span>    <span class="warning"><span class="keyword">new</span> GuardedAsyncTask&lt;Void, Void>(getReactApplicationContext()) {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 390 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 391 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> doInBackgroundGuarded(Void... params) {
<span class="lineno"> 392 </span>        <span class="keyword">if</span> (!ensureDatabase()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/ReactDatabaseSupplier.java">../../src/main/java/com/reactnativecommunity/asyncstorage/ReactDatabaseSupplier.java</a>:40</span>: <span class="message">Do not place Android context classes in static fields (static reference to <code>ReactDatabaseSupplier</code> which has field <code>mContext</code> pointing to <code>Context</code>); this is a memory leak</span><br /><pre class="errorlines">
<span class="lineno">  37 </span>          VALUE_COLUMN + <span class="string">" TEXT NOT NULL"</span> +
<span class="lineno">  38 </span>          <span class="string">")"</span>;
<span class="lineno">  39 </span>
<span class="caretline"><span class="lineno">  40 </span>  <span class="keyword">private</span> <span class="warning"><span class="keyword">static</span></span> <span class="annotation">@Nullable</span> ReactDatabaseSupplier sReactDatabaseSupplierInstance;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  41 </span>
<span class="lineno">  42 </span>  <span class="keyword">private</span> Context mContext;
<span class="lineno">  43 </span>  <span class="keyword">private</span> <span class="annotation">@Nullable</span> SQLiteDatabase mDb;
</pre>
...
Dismiss</button>            </div>
          ...
          </section><a name="KaptUsageInsteadOfKsp"></a>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:124</span>: <span class="message">This library supports using KSP instead of kapt, which greatly improves performance. Learn more: <a href="https://developer.android.com/studio/build/migrate-to-ksp">https://developer.android.com/studio/build/migrate-to-ksp</a></span><br /><pre class="errorlines">
<span class="lineno"> 121 </span>    implementation <span class="string">"androidx.room:room-runtime:$room_version"</span>
<span class="lineno"> 122 </span>    implementation <span class="string">"androidx.room:room-ktx:$room_version"</span>
<span class="lineno"> 123 </span>    implementation <span class="string">"org.jetbrains.kotlinx:kotlinx-coroutines-android:$coroutines_version"</span>
<span class="caretline"><span class="lineno"> 124 </span>    <span class="warning">kapt <span class="string">"androidx.room:room-compiler:$room_version"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 125 </span>
<span class="lineno"> 126 </span>    testImplementation <span class="string">"junit:junit:$junit_version"</span>
<span class="lineno"> 127 </span>    testImplementation <span class="string">"androidx.test:runner:$androidxtest_version"</span>
</pre>
