...
<span class="lineno"> 14 </span>        dependencies {
<span class="lineno"> 15 </span>            classpath <span class="string">'com.android.tools.build:gradle:4.1.2'</span>
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:41</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno"> 38 </span>        <span class="comment">// All of React Native (JS, Obj-C sources, Android binaries) is installed from npm</span>
<span class="lineno"> 39 </span>        url <span class="string">"$rootDir/../node_modules/react-native/android"</span>
<span class="lineno"> 40 </span>    }
<span class="caretline"><span class="lineno"> 41 </span>    <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:15</span>: <span class="message">A newer version of com.android.tools.build:gradle than 4.1.2 is available: 8.13.1. (There is also a newer version of 4.1.&#55349;&#56421; available, if upgrading to 8.13.1 is difficult: 4.1.3)</span><br /><pre class="errorlines">
<span class="lineno"> 12 </span>            jcenter()
<span class="lineno"> 13 </span>        }
<span class="lineno"> 14 </span>        dependencies {
<span class="caretline"><span class="lineno"> 15 </span>            classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:4.1.2'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/th3rdwave/safeareacontext/SafeAreaUtils.java">../../src/main/java/com/th3rdwave/safeareacontext/SafeAreaUtils.java</a>:14</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 11 </span><span class="comment">/* package */</span> <span class="keyword">class</span> SafeAreaUtils {
<span class="lineno"> 12 </span>
<span class="lineno"> 13 </span>  <span class="keyword">private</span> <span class="keyword">static</span> <span class="annotation">@Nullable</span> EdgeInsets getRootWindowInsetsCompat(View rootView) {
<span class="caretline"><span class="lineno"> 14 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 15 </span>      WindowInsets insets = rootView.getRootWindowInsets();
<span class="lineno"> 16 </span>      <span class="keyword">if</span> (insets == <span class="keyword">null</span>) {
<span class="lineno"> 17 </span>        <span class="keyword">return</span> <span class="keyword">null</span>;
</pre>
