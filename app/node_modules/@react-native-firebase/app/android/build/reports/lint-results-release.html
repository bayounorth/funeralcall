...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Nov 18 12:54:15 EST 2025 by AGP (8.6.0)</nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java">../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java</a>:191</span>: <span class="message">Use of this function is discouraged because resource reflection makes it harder to perform build optimizations and compile-time verification of code. It is much more efficient to retrieve resources by identifier (e.g. <code>R.foo.bar</code>) than by name (e.g. <code>getIdentifier("bar", "foo", null)</code>).</span><br /><pre class="errorlines">
<span class="lineno"> 188 </span>  <span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">int</span> getResId(Context ctx, String resName) {
<span class="lineno"> 189 </span>    <span class="keyword">int</span> resourceId = ctx
<span class="lineno"> 190 </span>      .getResources()
<span class="caretline"><span class="lineno"> 191 </span>      .<span class="warning">getIdentifier</span>(resName, <span class="string">"string"</span>, ctx.getPackageName());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 192 </span>
<span class="lineno"> 193 </span>    <span class="keyword">if</span> (resourceId == <span class="number">0</span>) {
<span class="lineno"> 194 </span>      Log.e(TAG, <span class="string">"resource "</span> + resName + <span class="string">" could not be found"</span>);
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/reactnative/java/io/invertase/firebase/utils/ReactNativeFirebaseUtilsModule.java">../../src/reactnative/java/io/invertase/firebase/utils/ReactNativeFirebaseUtilsModule.java</a>:163</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 160 </span>    constants.put(KEY_CACHE_DIRECTORY, context.getCacheDir().getAbsolutePath());
<span class="lineno"> 161 </span>
<span class="lineno"> 162 </span>    File externalDirectory = context.getExternalFilesDir(<span class="keyword">null</span>);
<span class="caretline"><span class="lineno"> 163 </span>    <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 164 </span>      <span class="keyword">if</span> (externalDirectory != <span class="keyword">null</span>) {
<span class="lineno"> 165 </span>        constants.put(KEY_DOCUMENT_DIRECTORY, externalDirectory.getAbsolutePath());
<span class="lineno"> 166 </span>      } <span class="keyword">else</span> {
</pre>

<span class="location"><a href="../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java">../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java</a>:141</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 138 </span>
<span class="lineno"> 139 </span>      <span class="keyword">if</span> (backgroundActivities.size() != <span class="number">0</span>) {
<span class="lineno"> 140 </span>        String currentActivity = <span class="string">""</span>;
<span class="caretline"><span class="lineno"> 141 </span>        <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 142 </span>          List&lt;ActivityManager.AppTask> taskInfo = activityManager.getAppTasks();
<span class="lineno"> 143 </span>          <span class="keyword">if</span> (taskInfo.size() > <span class="number">0</span>) {
<span class="lineno"> 144 </span>            ActivityManager.RecentTaskInfo task = taskInfo.get(<span class="number">0</span>).getTaskInfo();
</pre>

<span class="location"><a href="../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java">../../src/reactnative/java/io/invertase/firebase/common/SharedUtils.java</a>:145</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 142 </span>          List&lt;ActivityManager.AppTask> taskInfo = activityManager.getAppTasks();
<span class="lineno"> 143 </span>          <span class="keyword">if</span> (taskInfo.size() > <span class="number">0</span>) {
<span class="lineno"> 144 </span>            ActivityManager.RecentTaskInfo task = taskInfo.get(<span class="number">0</span>).getTaskInfo();
<span class="caretline"><span class="lineno"> 145 </span>            <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 146 </span>              currentActivity = task.baseActivity.getShortClassName();
<span class="lineno"> 147 </span>            } <span class="keyword">else</span> {
<span class="lineno"> 148 </span>              currentActivity = task.origActivity != <span class="keyword">null</span> ?
</pre>
