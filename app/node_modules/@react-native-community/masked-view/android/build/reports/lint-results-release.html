...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:9</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno">  6 </span>  <span class="keyword">if</span> (project == rootProject) {
<span class="lineno">  7 </span>    repositories {
<span class="lineno">  8 </span>      google()
<span class="caretline"><span class="lineno">  9 </span>      <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 10 </span>    }
<span class="lineno"> 11 </span>
<span class="lineno"> 12 </span>    dependencies {
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:48</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno"> 45 </span>
<span class="lineno"> 46 </span>repositories {
<span class="lineno"> 47 </span>  google()
<span class="caretline"><span class="lineno"> 48 </span>  <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 49 </span>  maven { url <span class="string">"https://jitpack.io"</span> }
<span class="lineno"> 50 </span>  maven {
<span class="lineno"> 51 </span>    <span class="comment">// All of React Native (JS, Obj-C sources, Android binaries) is installed from npm</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:13</span>: <span class="message">A newer version of com.android.tools.build:gradle than 3.3.1 is available: 8.13.1. (There is also a newer version of 3.3.&#55349;&#56421; available, if upgrading to 8.13.1 is difficult: 3.3.3)</span><br /><pre class="errorlines">
<span class="lineno"> 10 </span>    }
<span class="lineno"> 11 </span>
<span class="lineno"> 12 </span>    dependencies {
<span class="caretline"><span class="lineno"> 13 </span>      classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:3.3.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:57</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 54 </span>}
<span class="lineno"> 55 </span>
<span class="lineno"> 56 </span>dependencies {
<span class="caretline"><span class="lineno"> 57 </span>  implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 58 </span>}
<span class="lineno"> 59 </span>afterEvaluate {
<span class="lineno"> 60 </span>    tasks.whenTaskAdded { task ->
</pre>
