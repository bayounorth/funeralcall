...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ResourceType"><i class="material-icons error-icon">error</i>Wrong Resource Type (1)</a>
      <a class="mdl-navigation__link" href="#InternalInsetResource"><i class="material-icons warning-icon">warning</i>Using internal inset dimension resource (1)</a>
...
<a href="#ResourceType">ResourceType</a>: Wrong Resource Type</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#InternalInsetResource">InternalInsetResource</a>: Using internal inset dimension resource</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
...
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="ResourceTypeCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Wrong Resource Type</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/mf/translucentmodal/TranslucentModalHostHelper.java">../../src/main/java/com/mf/translucentmodal/TranslucentModalHostHelper.java</a>:45</span>: <span class="message">Expected resource of type styleable</span><br /><pre class="errorlines">
<span class="lineno"> 42 </span>
<span class="lineno"> 43 </span>    <span class="keyword">int</span>[] attrs = {android.R.attr.windowFullscreen};
<span class="lineno"> 44 </span>    Resources.Theme theme = context.getTheme();
<span class="caretline"><span class="lineno"> 45 </span>    TypedArray ta = theme.obtainStyledAttributes(<span class="error">attrs</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 46 </span>    <span class="keyword">boolean</span> windowFullscreen = ta.getBoolean(<span class="number">0</span>, <span class="keyword">false</span>);
<span class="lineno"> 47 </span>
<span class="lineno"> 48 </span>    <span class="comment">// We need to add the status bar height to the height if we have a fullscreen window,</span></pre>

</div>
<div class="metadata"><div class="explanation" id="explanationResourceType" style="display: none;">
...
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">ResourceType</span>
</span>
<span class="mdl-chip">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 7/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationResourceTypeLink" onclick="reveal('explanationResourceType');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="ResourceTypeCardLink" onclick="hideid('ResourceTypeCard');">
Dismiss</button>            </div>
            </div>
          </section><a name="InternalInsetResource"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="InternalInsetResourceCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Using internal inset dimension resource</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/mf/translucentmodal/TranslucentModalHostHelper.java">../../src/main/java/com/mf/translucentmodal/TranslucentModalHostHelper.java</a>:51</span>: <span class="message">Using internal inset dimension resource <code>status_bar_height</code> is not supported</span><br /><pre class="errorlines">
<span class="lineno"> 48 </span>    <span class="comment">// We need to add the status bar height to the height if we have a fullscreen window,</span>
<span class="lineno"> 49 </span>    <span class="comment">// because Display.getCurrentSizeRange doesn't include it.</span>
<span class="lineno"> 50 </span>    Resources resources = context.getResources();
<span class="caretline"><span class="lineno"> 51 </span>    <span class="keyword">int</span> statusBarId = <span class="warning">resources.getIdentifier(<span class="string">"status_bar_height"</span>, <span class="string">"dimen"</span>, <span class="string">"android"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 52 </span>    <span class="keyword">int</span> statusBarHeight = <span class="number">0</span>;
<span class="lineno"> 53 </span>    <span class="keyword">if</span> (windowFullscreen &amp;&amp; statusBarId > <span class="number">0</span>) {
<span class="lineno"> 54 </span>        statusBarHeight = (<span class="keyword">int</span>) resources.getDimension(statusBarId);
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationInternalInsetResource" style="display: none;">
The internal inset dimension resources are not a supported way to retrieve the relevant insets for your application. The insets are dynamic values that can change while your app is visible, and your app's window may not intersect with the system UI. To get the relevant value for your app and listen to updates, use <code>androidx.core.view.WindowInsetsCompat</code> and related APIs.<br/>To suppress this error, use the issue id "InternalInsetResource" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">InternalInsetResource</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Correctness</span>
</span>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 6/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationInternalInsetResourceLink" onclick="reveal('explanationInternalInsetResource');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="InternalInsetResourceCardLink" onclick="hideid('InternalInsetResourceCard');">
Dismiss</button>            </div>
            </div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:5</span>: <span class="message">A newer version of <code>compileSdkVersion</code> than 28 is available: 34</span><br /><pre class="errorlines">
<span class="lineno">  2 </span>
<span class="lineno">  3 </span>android {
<span class="lineno">  4 </span>    namespace <span class="string">"com.mf.translucentmodal"</span>
<span class="caretline"><span class="lineno">  5 </span>    <span class="warning">compileSdkVersion <span class="number">28</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:34</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 31 </span>    testImplementation <span class="string">'junit:junit:4.12'</span>
<span class="lineno"> 32 </span>    androidTestImplementation <span class="string">'com.android.support.test:runner:1.0.2'</span>
<span class="lineno"> 33 </span>    androidTestImplementation <span class="string">'com.android.support.test.espresso:espresso-core:3.0.2'</span>
<span class="caretline"><span class="lineno"> 34 </span>    implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
Dismiss</button>            </div>
          ...
          </section><a name="VisibleForTests"></a>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/mf/translucentmodal/TranslucentModalHostView.java">../../src/main/java/com/mf/translucentmodal/TranslucentModalHostView.java</a>:57</span>: <span class="message">This method should only be accessed from tests or within private scope</span><br /><pre class="errorlines">
<span class="lineno">  54 </span>    <span class="annotation">@Override</span>
<span class="lineno">  55 </span>    <span class="keyword">protected</span> <span class="keyword">void</span> showOrUpdate() {
<span class="lineno">  56 </span>        <span class="keyword">super</span>.showOrUpdate();
<span class="caretline"><span class="lineno">  57 </span>        Dialog dialog = <span class="warning">getDialog</span>();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  58 </span>        <span class="keyword">if</span> (dialog != <span class="keyword">null</span>) {
<span class="lineno">  59 </span>            setStatusBarTranslucent(dialog.getWindow(), <span class="keyword">true</span>);
<span class="lineno">  60 </span>            setStatusBarColor(dialog.getWindow(), Color.TRANSPARENT);
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:11</span>: <span class="message">Google Play requires that apps target API level 33 or higher.</span><br /><pre class="errorlines">
<span class="lineno">  8 </span>
<span class="lineno">  9 </span>    defaultConfig {
<span class="lineno"> 10 </span>        minSdkVersion <span class="number">15</span>
<span class="caretline"><span class="lineno"> 11 </span>        <span class="error">targetSdkVersion <span class="number">28</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
